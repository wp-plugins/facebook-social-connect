<?php
    ...
    */
	...
	function __construct()
        ...
        *   Checks if user is already a member of Wordpress and facebook.
	...
	public function fbc_set_user_info($fb_user)
        ...
        /**
        *   Function to create WP User and logg into the site.
        *   @uses Facebook Graph API.
        *   @param $access_token - String Access Token of FB User
        *   @return mixed user object or false
        */
	private function fbc_create_wp_user($fb_user)
		...
		if($result)
		    ...
		    if(!$wp_userid)
                    {
			throw new Exception('FC Error : Could not create user.');
                    }
